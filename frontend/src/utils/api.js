...
const MOCK_DEVICES = [
  { id: 1, ip_address: "192.168.1.1", mac_address: "00:11:22:33:44:55", name: "Gateway Router", category: "Router", location: "Stage", is_monitored: true, is_muted: false, mute_until: null, status: "online", last_latency: 2.4, rx_mbps: 45.2, tx_mbps: 18.7, last_seen: new Date().toISOString(), created_at: new Date().toISOString(), show_on_map: true },
  { id: 2, ip_address: "192.168.1.2", mac_address: "00:11:22:33:aa:bb", name: "Core Omada Switch", category: "Switch", location: "Office", is_monitored: true, is_muted: false, mute_until: null, status: "online", last_latency: 1.8, rx_mbps: 128.4, tx_mbps: 84.1, last_seen: new Date().toISOString(), created_at: new Date().toISOString(), show_on_map: true },
  { id: 3, ip_address: "192.168.1.10", mac_address: "aa:bb:cc:dd:ee:01", name: "Cashier POS 1", category: "POS", location: "Cashier", is_monitored: true, is_muted: false, mute_until: null, status: "online", last_latency: 4.1, rx_mbps: 1.2, tx_mbps: 0.4, last_seen: new Date().toISOString(), created_at: new Date().toISOString(), show_on_map: true },
  { id: 4, ip_address: "192.168.1.11", mac_address: "aa:bb:cc:dd:ee:02", name: "Bar POS 2", category: "POS", location: "Bar", is_monitored: true, is_muted: false, mute_until: null, status: "warning", last_latency: 142.6, rx_mbps: 0.8, tx_mbps: 0.2, last_seen: new Date().toISOString(), created_at: new Date().toISOString(), show_on_map: true },
  { id: 5, ip_address: "192.168.1.20", mac_address: "22:33:44:55:66:77", name: "Kitchen KDS Monitor", category: "Monitor KDS", location: "Kitchen", is_monitored: true, is_muted: false, mute_until: null, status: "online", last_latency: 3.5, rx_mbps: 4.5, tx_mbps: 1.1, last_seen: new Date().toISOString(), created_at: new Date().toISOString(), show_on_map: true },
  { id: 6, ip_address: "192.168.1.50", mac_address: "f0:25:72:a1:b2:c3", name: "Bar CCTV IP Cam", category: "CCTV", location: "Bar", is_monitored: true, is_muted: false, mute_until: null, status: "online", last_latency: 5.2, rx_mbps: 0.1, tx_mbps: 8.4, last_seen: new Date().toISOString(), created_at: new Date().toISOString(), show_on_map: true },
  { id: 7, ip_address: "192.168.1.51", mac_address: "f0:25:72:a1:b2:c4", name: "Stage CCTV IP Cam", category: "CCTV", location: "Stage", is_monitored: true, is_muted: true, mute_until: new Date(Date.now() + 30 * 60000).toISOString(), status: "offline", last_latency: null, rx_mbps: 0.0, tx_mbps: 0.0, last_seen: new Date(Date.now() - 3600000).toISOString(), created_at: new Date().toISOString(), show_on_map: true },
  { id: 8, ip_address: "192.168.1.100", mac_address: "cc:cc:cc:11:22:33", name: "HP LaserJet Receipts", category: "Printer", location: "Cashier", is_monitored: true, is_muted: false, mute_until: null, status: "online", last_latency: 8.7, rx_mbps: 0.3, tx_mbps: 0.1, last_seen: new Date().toISOString(), created_at: new Date().toISOString(), show_on_map: true },
  { id: 9, ip_address: "192.168.1.201", mac_address: "bc:5f:f4:90:12:34", name: "Office Admin PC", category: "PC", location: "Office", is_monitored: true, is_muted: false, mute_until: null, status: "online", last_latency: 2.1, rx_mbps: 15.8, tx_mbps: 5.4, last_seen: new Date().toISOString(), created_at: new Date().toISOString(), show_on_map: true }
];
